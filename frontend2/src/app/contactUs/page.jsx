...
const ContactUs = () => {
  ...
  <div className="container mx-auto px-5 py-24">
    ...
    <form action="" onSubmit={contactusForm.handleSubmit}>
    <div className="mx-auto md:w-2/3 lg:w-1/2">
      <div className="-m-2 flex flex-wrap">
        ...
        <div className="w-1/2 p-2">
          <div className="relative">
            <input
              ...
              id="name"
              name="name"
              onChange={contactusForm.errors.name}
            ...
            {contactusForm.errors.name && contactusForm.touched.email ? ( <div className='text-indigo-600'>{contactusForm.errors.email}</div> ): null}
          </div>
        </div>
        <div className="w-1/2 p-2">
          <div className="relative">
            <input
              ...
              id="email"
              name="email"
              onChange={contactusForm.errors.email}
            ...
            {contactusForm.errors.email && contactusForm.touched.email ? ( <div className='text-indigo-600'>{contactusForm.errors.email}</div> ): null}
          </div>
        </div>
        ...
        <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
          <a className="text-indigo-400">akhilesh@email.com</a>
