...
const contactSchema = Yup.object().shape({
  ...
  details: Yup.string() 
  .min(10,' Details must be at least 10 charecters')
  .max(80,' Details must be at least 80 charecters'),
})
const ContactUs = () => {
          ...
          <div className="grid gap-4 lg:gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              <div>
                ...
                />
                {contactUsForm.errors.firstName && contactUsForm.touched.firstName ? (
                <div className="text-red-500">{contactUsForm.errors.firstName}</div>
                ):null}
              </div>
              <div>
                <label
                ...
                <input
                  ...
                  className="py-3 px-4 block w-full border-2 border-gray-200  rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                />
                {contactUsForm.errors.lastName && contactUsForm.touched.lastName ? (
                <div className="text-red-500">{contactUsForm.errors.lastName}</div>
                ):null}
              </div>
            </div>
            {/* End Grid */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              <div>
                ...
                <div className="text-red-500">{contactUsForm.errors.email}</div>
                ):null}
              </div>
              <div>
                <label
                ...
                <input
                  ...
                  className="py-3 px-4 block w-full border-2 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                />
                {contactUsForm.errors.phoneNumber && contactUsForm.touched.phoneNumber ? (
                <div className="text-red-500">{contactUsForm.errors.phoneNumber}</div>
                ):null}
              </div>
            </div>
            {/* End Grid */}
            <div>
              ...
              <textarea
                ...
                name="details"
                placeholder ='Enter detail addresses'
                rows={2}
                onChange={contactUsForm.handleChange}
              ...
              />
                ...
                <div className="text-red-500">{contactUsForm.errors.details}</div>
                ):null}
            </div>
          </div>
          {/* End Grid */}
